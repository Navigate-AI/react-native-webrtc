...
var _RTCIceCandidateErrorEvent = _interopRequireDefault(require("./RTCIceCandidateErrorEvent"));
var _RTCIceCandidateEvent = _interopRequireDefault(require("./RTCIceCandidateEvent"));
var _RTCIceSelectedCandidatePairChangedEvent = _interopRequireDefault(require("./RTCIceSelectedCandidatePairChangedEvent"));
...
class RTCPeerConnection extends _index.EventTarget {
  ...
  _registerEvents() {
    ...
    (0, _EventEmitter.addListener)(this, 'peerConnectionGotICECandidateError', ev => {
      if (ev.pcId !== this._pcId) {
        return;
      }
      this.dispatchEvent(new _RTCIceCandidateErrorEvent.default('icecandidateerror', ev));
    });
    ...
    (0, _EventEmitter.addListener)(this, 'peerConnectionIceSelectedCandidatePairChanged', ev => {
      if (ev.pcId !== this._pcId) {
        return;
      }
      this.dispatchEvent(new _RTCIceSelectedCandidatePairChangedEvent.default(ev));
    });
